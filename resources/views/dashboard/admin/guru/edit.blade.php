      ...
      <form action="{{url('guru/'. $guru->id)}}" method="POST">
        ...
        <div class="form-group">
          <input type="text" name="nama_lengkap"
            ...
            aria-describedby="emailHelp" placeholder="Nama Lengkap..." value="{{$guru->nama_lengkap}}">
          @error('nama_lengkap')
        ...
        <div class="form-group">
          <input type="text" name="username"
            ...
            aria-describedby="emailHelp" placeholder="Username..." value="{{$guru->username}}">
          @error('username')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
        ...
        {{-- <div class="form-group">
          <input type="text" name="role" class="form-control form-control-user @error('role') is-invalid @enderror"
            id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Role...">
          @error('role')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
        ...
        <div class="form-group">
          <input type="password" name="password"
            ...
            placeholder="Password...." value="{{$guru->password}}">
          @error('password')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
